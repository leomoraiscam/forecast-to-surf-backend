...
describe('Beaches functional', () => {
  ...
  describe ('When create a beach', () => {
    ...
    it.skip('should return throw 422 when there is a validation error', async () => {
      const newBeach = {
        lat: 'invalid_string',
        lng: 151.289824,
        name: 'Manly',
      ...
      expect(response.body).toEqual({
        error: 
          'Beach validation failed: lat: Cast to Number failed for value "invalid_string" (type string) path "lat"',
      })
    });
