...
describe('Rating service tests', () => {
  ...
  describe('Get rating based on swell period', () => {
    it('should be able to get a rating of 1 for a period of 5 seconds', () => {
      const rating = defaultRating.getRatingForSwellPeriod(5);

      expect(rating).toBe(1);
    });

    it('should be able to get a rating of 2 for a period of 9 seconds', () => {
      const rating = defaultRating.getRatingForSwellPeriod(9);

      expect(rating).toBe(2);
    });

    it('should be able to get a rating of 4 for a period of 12 seconds', () => {
      const rating = defaultRating.getRatingForSwellPeriod(12);

      expect(rating).toBe(4);
    });

    it('should be able to get a rating of 5 for a period of 16 seconds', () => {
  ...
  describe('Get rating based on swell height', () => {
    ...
    it('should be able to get rating 5 for overhead swell', () => {
